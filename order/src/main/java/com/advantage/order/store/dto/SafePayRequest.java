...
//    private String customerName;      //  2-30 characters ([A-Za-z]{2,30})
    ...
    public SafePayRequest() {
    }

    public SafePayRequest(String transactionType, String userName, String password, String customerPhone, String transactionDate, long accountNumber, double value, String currency) {
